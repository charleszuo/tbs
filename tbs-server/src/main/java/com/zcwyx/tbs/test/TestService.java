...
public class TestService {
	...
	public static class AsyncClient extends
		...
		public void getName(
				...
				throws org.apache.thrift.TException {
			checkReady();
			getName_call method_call = new getName_call(resultHandler, this,
					___protocolFactory, ___transport);
			this.___currentMethod = method_call;
			___manager.call(method_call);
		}

		public static class getName_call extends
	...
	public static class Processor<I extends Iface> extends
		...
		public static class getName<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, getName_args> {
			public getName() {
				super("getName");
			}
			...
			public getName_result getResult(I iface, getName_args args)
					throws org.apache.thrift.TException {
				getName_result result = new getName_result();
	...
	public static class getName_args implements
			org.apache.thrift.TBase<getName_args, getName_args._Fields>,
			java.io.Serializable, Cloneable, Comparable<getName_args> {
		...
		static {
			schemes.put(StandardScheme.class,
					new getName_argsStandardSchemeFactory());
		...
		static {
			...
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					getName_args.class, metaDataMap);
		}
		...
		private static class getName_argsStandardSchemeFactory implements
				SchemeFactory {
		...
		private static class getName_argsStandardScheme extends
				StandardScheme<getName_args> {

			public void read(org.apache.thrift.protocol.TProtocol iprot,
					getName_args struct) throws org.apache.thrift.TException {
		...
		private static class getName_argsTupleSchemeFactory implements
				SchemeFactory {
		...
		private static class getName_argsTupleScheme extends
				TupleScheme<getName_args> {
	...
	public static class getName_result implements
			org.apache.thrift.TBase<getName_result, getName_result._Fields>,
			java.io.Serializable, Cloneable, Comparable<getName_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"getName_result");
		...
		static {
			schemes.put(StandardScheme.class,
					new getName_resultStandardSchemeFactory());
			schemes.put(TupleScheme.class,
					new getName_resultTupleSchemeFactory());
		}
		...
		static {
			...
			metaDataMap = Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					getName_result.class, metaDataMap);
		}
		...
		private static class getName_resultStandardSchemeFactory implements
				SchemeFactory {
		...
		private static class getName_resultStandardScheme extends
				StandardScheme<getName_result> {

			public void read(org.apache.thrift.protocol.TProtocol iprot,
					getName_result struct) throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
					schemeField = iprot.readFieldBegin();
		...
		private static class getName_resultTupleSchemeFactory implements
				SchemeFactory {
		...
		private static class getName_resultTupleScheme extends
				TupleScheme<getName_result> {
